 ...
 */
final class Version20210913210303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, isbn VARCHAR(13) NOT NULL, title VARCHAR(255) NOT NULL, summary LONGTEXT NOT NULL, price NUMERIC(10, 0) NOT NULL, INDEX IDX_CBE5A331F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE purchase (id INT AUTO_INCREMENT NOT NULL, book_id INT NOT NULL, customer_id INT NOT NULL, purchase_date DATE NOT NULL, UNIQUE INDEX UNIQ_6117D13B16A2B381 (book_id), INDEX IDX_6117D13B9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
